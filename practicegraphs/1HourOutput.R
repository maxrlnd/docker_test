...
experimentallist$herdsize = sample(400:600, 200, replace = FALSE)
...
experimentallist$mTurkID =  factor(experimentallist$mTurkID )
 ...
 experimentallist$name = ifelse(experimentallist$mTurkID == 30, "Jeff",
...
ggplot(experimentallist, aes(year, herdsize, group = insurance, color = insurance)) +
  geom_line() +
