  ...
  lapply(1:simLength, function(i){
    ...
    assign(paste0("reactiveWinter", i), reactive({
      ...
      tagList(
        ...
        br(),
        h4("Range Condition"),
        p("Your range health is currently at ", span(ifelse(round(sum(get(paste0("currentZones", i))()) * 100, 0) > 100, 100, round(sum(get(paste0("currentZones", i))()) * 100, 0)),style="font-weight:bold;font-size:large"), "%."),
        p("Remember, if your range health drops below 100%, for any level of rainfall, you will produce less grass to feed your herd than if your range were at full health."),
        br(),
        h4("Bills Due"),
