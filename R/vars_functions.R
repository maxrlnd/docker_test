...
getSimVars=function(random.starts=F,random.acres=F,random.productivity=F,random.coverage=F,
                    use.forage=F,autoSelect.insurance=F,clv=0.9,acres=3000,pfactor=1){
