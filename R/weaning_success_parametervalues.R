...
forage.potential <- seq(from = 0, to = 1, by = 0.1)
...
forage.weaning <- data.frame(forage.potential = forage.potential.years$forage.potential, wn.succ_yr1, wn.succ_yr2)
ggplot(forage.weaning, aes(x = forage.potential)) + geom_density()
