...
\begin{align}
wn.succ_1 = normal.wn.succ * \frac{1}{1 + e^{2(-1 + \alpha)}} 
\end{align}
%wn.succ_2 = normal.wn.succ * \frac{1}{1 + e^{(-1 + \alpha)}
%\verb!wn.succ_3! &= normal.wn.succ \\
%\verb!wn.succ_4! &= normal.wn.succ \\
%\verb!wn.succ_5! &= normal.wn.succ \\
%\end{align}
